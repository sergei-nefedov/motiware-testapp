...
public class WorkController {
    ...
    @Operation(
            ...
            description = "При создании задаются название работы, даты ее начала и окончания, данные об исполнителе, и идентификатор" +
                    ...
                    " Процент выполнения работы при создании автоматически устанавливаются равным 0."
    )
    @PostMapping("/create")
    ...
    @Operation(
            ...
            description = "Можно изменить название работы, даты ее начала и окончания, данные об исполнителе, процент выполнения, " + // TODO check the all variants of patching
                    ...
                    "Чтобы не изменять процент выполнения, в качестве значения передается 0; чтобы не изменять проект или " +
                    "контрольную точку, к которым привязана работа, в качестве идентификаторов также передается 0."
    )
    @PatchMapping("/patch")
