...
public class WorkController {
    ...
    /* TODO
        Получение всех работ требуемой контрольной точки; - done
        Окончание работы не может быть больше окончания контрольной точки; - done
        Для работы может быть 1 проект и 1 контрольная точка - done
        Наименование контрольной точки уникальное для проекта - done
        - Загрузка контрольных точек из файла для требуемого проекта. Сопоставление - done
